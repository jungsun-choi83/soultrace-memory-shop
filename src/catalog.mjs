...
export const PRODUCTS = Object.freeze([
  ...
  },
  {
    ...
    details: [['구성', '편지 · 엽서 · NFC 인식표'], ['NFC 인식표', '제공된 가죽 홀더 시안'], ['맞춤 항목', '아이 이름 · 남기고 싶은 문장 · 사진'], ['확인 예정', '용지 · 인쇄 방식 · 구성 수량 · 칩 사양 · 제작 일정']],
  },
  {
...
export const FAQS = [
  ['소울트레이스에서 만든 편지를 가져올 수 있나요?', '기존 계정의 편지와 사진을 선택하는 연결 화면을 준비했습니다. 현재 버전에서는 보리의 예시 이야기만 불러오며, 실제 계정에 로그인하거나 서버에서 개인 정보를 가져오지 않습니다. 실제 아카이브 API는 운영 서비스 연결 시 추가해야 합니다.'],
