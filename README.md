...
NFC 메모리카드가 카탈로그 1번입니다. 편지 세트 구성은 편지 · 엽서 · NFC 인식표이며, 인식표는 제공된 가죽 홀더 시안입니다.
...
- localStorage에는 상품 ID/옵션/수량/임의 항목 ID만 저장합니다.
...
QR/NFC, 운영자 화면, 다국어·해외 결제, 배포와 도메인 연결은 **미구현**입니다.
